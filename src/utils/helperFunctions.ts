...
const poolsSymbols: Record<string, string> = {
  ...
  [`${AaveV3Sonic.POOL}_${AaveV3Sonic.CHAIN_ID}`]: "Son",
  [`${AaveV3XLayer.POOL}_${AaveV3XLayer.CHAIN_ID}`]: "Xlr",
  [`${AaveV3Soneium.POOL}_${AaveV3Soneium.CHAIN_ID}`]: "Sone",
  [`${AaveV3MegaEth.POOL}_${AaveV3MegaEth.CHAIN_ID}`]: "Meg",
  [`${AaveV3Mantle.POOL}_${AaveV3Mantle.CHAIN_ID}`]: "Man",
  [`${AaveV3Plasma.POOL}_${AaveV3Plasma.CHAIN_ID}`]: "Pla",
  [`${AaveV3Celo.POOL}_${AaveV3Celo.CHAIN_ID}`]: "Cel",
  [`${AaveV3InkWhitelabel.POOL}_${AaveV3InkWhitelabel.CHAIN_ID}`]: "InkWl",
  [`${AaveV3Linea.POOL}_${AaveV3Linea.CHAIN_ID}`]: "Lin",
